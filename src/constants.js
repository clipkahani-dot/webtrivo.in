...
export const PRICING_PLANS = [
  {
    id: 'starter',
    name: 'Starter Express Profile',
    nameHi: '1-Page Digital Visiting Card',
    price: '₹4,999',
    originalPrice: '₹8,999',
    delivery: '2–3 Working Days',
    idealFor: 'Solo local shops, freelance consultants & single-service professionals',
    description: 'Ultra-fast 1-page digital presence to display your basic contact, store location, and accept direct WhatsApp messages.',
    popular: false,
    badge: 'Basic Express',
    scopeBadge: '1 Single Page • Max 5 Services',
    features: [
    ...
    notIncluded: [
      'No Doctor / Staff Qualification Profiles',
      'No OPD Shift Timings Schedule Table',
      'No 15–20 In-Depth Treatment Catalog',
      'No Google 4.9★ Reviews Badge Showcase',
      'No Patient Video Testimonials Player'
    ],
    ctaText: 'Choose Starter (₹4,999)',
    whatsappMsg: 'Hello Webtrivo! I want to get the Starter Express Profile plan (₹4,999). Please share details for a Quick Demo Preview.'
  },
  {
    id: 'growth',
    ...
    delivery: '2–3 Working Days',
    idealFor: 'Doctors, clinics, dental centers, retail showrooms, salons, gyms & firms',
    description: 'Complete high-converting multi-section platform with doctor credentials, interactive OPD shifts, 15–20 treatments, and reviews.',
    popular: true,
    badge: 'Most Popular • 90% Choose This ⭐',
    scopeBadge: 'Multi-Section Complete • 15–20 Services',
    features: [
      'Multi-Section Complete Interactive Platform (5+ Sections)',
      '15–20 Dedicated Treatments / Services with Descriptions',
      'Doctor & Staff Profile with Degrees (MBBS/MD) & Experience',
      'Interactive OPD Timings Table (Morning & Evening Shifts)',
      'Live 4.9★ Google Reviews & Patient Trust Badges',
      '4 Sticky WhatsApp Booking CTAs Across Key Sections',
      'Complete Local SEO Setup (Google Search & Maps Ready)',
    ...
    notIncluded: [
      'No Patient Video Testimonials Player Wall',
      'No Interactive Price / Budget Calculator'
    ],
    ctaText: 'Choose Clinic Pro (₹9,999)',
  ...
  },
  {
    ...
    nameHi: 'Flagship Multi-Branch Platform',
    price: '₹14,999',
    originalPrice: '₹24,999',
    delivery: '3–4 Working Days',
    idealFor: 'Hospitals, multi-speciality centers, expanding brands & corporate firms',
    description: 'Elite authority platform featuring embedded patient video interviews, multi-branch support, schema SEO, and direct developer VIP support.',
    popular: false,
    badge: 'Flagship Hospital / Brand',
    scopeBadge: 'Unlimited Scale • Video Wall • Multi-Branch',
    features: [
      'Everything in Clinic Pro Package Included',
      'Embedded Patient Video Testimonials Player Wall',
      'Multi-Branch / Multi-Speciality Clinic Directory',
      'Interactive Treatment Cost & Budget Estimator Tool',
      'Google Medical & LocalBusiness Schema Markup',
