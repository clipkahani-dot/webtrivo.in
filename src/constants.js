...
export const PRICING_PLANS = [
  {
    ...
    nameHi: '1-Page Express Profile',
    price: '₹4,999',
    originalPrice: '₹8,999',
    delivery: '2–3 Working Days',
    idealFor: 'Local shops, individual doctors, consultants, and solo professionals',
    description: 'Fast, modern, AI-powered 1-page website designed to generate direct, high-intent WhatsApp leads.',
    popular: false,
    badge: 'Quick Launch',
    features: [
      '1-Page Clean AI-Powered Responsive Design',
      'Quick Demo Preview to Lock Layout & Colors',
      'Direct WhatsApp 1-Click Inquiry Buttons',
      'Google Maps Location & Contact Embed',
      'About Business, Services & Timing Overview',
      'Customer Photo Showcase (Up to 8 photos)',
      'Free High-Speed Cloud Hosting (Netlify) + Lifetime SSL',
      'Client-Owned Domain Setup (~₹800 direct purchase guidance)',
      '1 Consolidated Revision Round (Minor text/alignment tweaks)',
      'Basic On-Page SEO Setup',
      '7 Days Post-Launch Bug Fixing Support'
    ],
    ctaText: 'Get Starter at ₹4,999',
    whatsappMsg: 'Hello Webtrivo! I am interested in the Starter Business Profile plan (₹4,999). Please share the details for a Quick Demo Preview.'
  },
  {
    id: 'growth',
    name: 'Growth / Clinic Pro',
    nameHi: 'Complete Interactive Website (Most Popular)',
    price: '₹9,999',
    originalPrice: '₹16,999',
    delivery: '2–3 Working Days',
    idealFor: 'Doctors, clinics, nursing homes, retail showrooms, salons, gyms & firms',
    description: 'Multi-section complete website featuring doctor/team profiles, OPD timings, treatment lists, and Google reviews.',
    popular: true,
    badge: 'Most Popular • Best Value ⭐',
    features: [
      'Multi-Section Complete Interactive Website',
      'Quick Demo Preview to Lock Layout & Theme',
      'Dedicated Services Catalog (15–20 Services/Treatments)',
      'Doctor & Staff Profile Showcase with Qualifications',
      'OPD / Consultation Timings & Appointment Forms',
      'Google 5-Star Reviews & QR Code Showcase',
      'Social Media Integration (Instagram, FB, LinkedIn)',
      'Free High-Speed Cloud Hosting (Netlify) + Lifetime SSL',
      'Client-Owned Domain Setup (~₹800 direct purchase guidance)',
      '1 Consolidated Revision Round (Minor text/alignment tweaks)',
      'Complete On-Page SEO (Google Search Console Ready)',
      '7 Days Dedicated Bug Fixing Support'
    ],
    ctaText: 'Get Clinic Pro at ₹9,999',
    whatsappMsg: 'Hello Webtrivo! I want to get the Growth / Clinic Pro package (₹9,999). Please guide me with a Quick Demo Preview.'
  },
  {
    id: 'ultimate',
    name: 'Ultimate Custom Brand',
    nameHi: 'Flagship Premium Package',
    price: '₹14,999',
    originalPrice: '₹24,999',
    delivery: '2–3 Working Days',
    idealFor: 'Hospitals, multi-speciality centers, corporate brands & expanding firms',
    description: 'Top-tier branded web solution featuring real video testimonial players, custom UI/UX, and local SEO schema.',
    popular: false,
    badge: 'Flagship Premium',
    features: [
      'Everything in Growth Clinic Pro +',
      'Custom Tailored Brand UI/UX Design System',
      'Real Video Testimonials Player Integration',
      'Multiple Branch / Hospital Locations Support',
      'Interactive Service Cost / Price Estimator Tool',
      'Google Knowledge Graph Schema (FAQ, MedicalClinic)',
      'Professional Business Email Setup Guidance',
      'Free High-Speed Cloud Hosting (Netlify) + Lifetime SSL',
      'Client-Owned Domain Setup Support',
      '1 Consolidated Revision Round',
      '7 Days Priority Bug Fixing Support'
    ],
    ctaText: 'Get Ultimate at ₹14,999',
    whatsappMsg: 'Hello Webtrivo! I am interested in the Ultimate Custom Brand package (₹14,999). Please connect with me for a Quick Demo Preview.'
  }
]
