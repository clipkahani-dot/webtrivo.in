      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base text-slate-600 mt-3">
            Choose the package that fits your business scale. All packages include a <strong>Quick Demo Preview</strong>, fast <strong>{DELIVERY_TIME}</strong> turnaround, free cloud hosting (Netlify), and 7-day bug-fixing support.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`rounded-3xl p-7 sm:p-8 flex flex-col justify-between transition-all duration-300 relative ${
                  plan.popular
                    ? 'bg-gradient-to-b from-sky-50/90 via-white to-white border-2 border-brand-blue shadow-2xl scale-100 lg:-translate-y-2'
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-brand-blue mb-4">
                    {plan.nameHi}
                  </p>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 mb-6">
                    ...
                    <div className="mt-2 flex items-center justify-between text-[11px] text-slate-600 font-medium">
                      ...
                      <span className="text-emerald-700 font-semibold">Free Cloud Hosting</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    {plan.features.map((feature, fIdx) => (
                      <div key={fIdx} className="flex items-start gap-2.5 text-xs text-slate-700">
                        <div className="w-4 h-4 rounded-full bg-sky-100 text-brand-blue flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-center text-[11px] text-slate-500 mt-2">
                    Get Quick Demo Preview on WhatsApp
                  </p>
                </div>
